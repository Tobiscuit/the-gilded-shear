      ...
      <header className="absolute top-0 left-0 right-0 z-10 px-4 py-3">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden lg:flex space-x-8">
            <a 
              className="text-white hover:text-yellow-400 transition-colors font-medium drop-shadow-lg" 
              href="#services"
            >
              Services
            </a>
          ...
          <div className="layout-content-container flex flex-col w-full flex-1">
            <div className="@container">
              <div className="flex flex-col-reverse lg:flex-row items-center min-h-screen">
                <div className="w-full lg:w-1/2 flex justify-center py-10 px-4 sm:px-8 lg:px-16" style={{backgroundColor: '#FFF8E7'}}>
                  <div className="max-w-md text-center lg:text-left">
                    ...
                    <button 
                      ...
                      className="mt-8 flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-8 bg-yellow-600 text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-yellow-700 transition-colors shadow-lg"
                    >
                ...
                <div 
                  className="w-full lg:w-1/2 h-96 lg:h-screen bg-center bg-no-repeat bg-cover" 
